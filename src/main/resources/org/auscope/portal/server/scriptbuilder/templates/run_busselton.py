...
name_stem = scenario_name = 'busselton'
...
# takes about 90 secs, total
default_res = 1000000

# takes about 9 secs, total
base_scale = 400000
...
anuga.asc2dem('busselton.asc', use_cache=v_cache, verbose=v_verbose)
...
cloudUpload("${name_stem}", "${name_stem}")
